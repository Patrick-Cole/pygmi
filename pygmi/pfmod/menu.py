...
# -----------------------------------------------------------------------------
"""Potential field modelling menu routines."""

from PySide6 import QtGui, QtWidgets

from pygmi.pfmod import iodefs, misc, mvis3d, pfinvert, pfmod, show_table
...
class MenuWidget:
    ...
    def pfmod(self):
        ...
        self.parent.item_insert("Step", "Potential Field Modelling", pfmod.MainWidget)

    def maginv(self):
        """Voxel inversion of data."""
        self.parent.item_insert("Step", "3D Magnetic Inversion", pfinvert.MagInvert)
