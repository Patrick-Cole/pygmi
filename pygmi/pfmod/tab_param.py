...
class ParamDisplay(object):
    ...
    def setupui(self):
        ...
        label_37 = QtGui.QLabel(self.gbox1)
        label_37.setText("Gravity Regional (mgal)")
        self.glayout.addWidget(label_37, 0, 0, 1, 1)
        ...
        label_38 = QtGui.QLabel(self.gbox1)
        label_38.setText("Height of observation - Gravity")
        self.glayout.addWidget(label_38, 2, 0, 1, 1)
        self.dsb_ght.setMaximum(999999999.0)
        self.glayout.addWidget(self.dsb_ght, 2, 1, 1, 1)

        label_39 = QtGui.QLabel(self.gbox1)
        label_39.setText("Height of observation - Magnetic")
        self.glayout.addWidget(label_39, 3, 0, 1, 1)
        self.dsb_mht.setMaximum(999999999.0)
        self.dsb_mht.setProperty("value", 100.0)
        self.glayout.addWidget(self.dsb_mht, 3, 1, 1, 1)

        label_4 = QtGui.QLabel(self.gbox1)
        label_4.setText("Magnetic Field Intensity (nT)")
        self.glayout.addWidget(label_4, 4, 0, 1, 1)
        self.dsb_hint.setMaximum(999999999.0)
        self.dsb_hint.setProperty("value", 27000.0)
        self.glayout.addWidget(self.dsb_hint, 4, 1, 1, 1)

        label_40 = QtGui.QLabel(self.gbox1)
        label_40.setText("Magnetic Inclination")
        self.glayout.addWidget(label_40, 5, 0, 1, 1)
        ...
        label_41 = QtGui.QLabel(self.gbox1)
        label_41.setText("Magnetic Declination")
        self.glayout.addWidget(label_41, 6, 0, 1, 1)
        ...
        label_8 = QtGui.QLabel(self.gbox_lithprops)
        label_8.setText("Magnetic Susceptibility (SI)")
        self.glayout3.addWidget(label_8, 4, 0, 1, 1)
        ...
        label_12 = QtGui.QLabel(self.gbox_lithprops)
        label_12.setText("Remanent Magnetization Intensity (nT)")
        self.glayout3.addWidget(label_12, 5, 0, 1, 1)
        ...
        label_13 = QtGui.QLabel(self.gbox_lithprops)
        label_13.setText("Q Ratio")
        self.glayout3.addWidget(label_13, 7, 0, 1, 1)
        self.dsb_qratio.setEnabled(True)
        self.dsb_qratio.setMaximum(999999999.0)
        self.glayout3.addWidget(self.dsb_qratio, 7, 1, 1, 1)

        label_14 = QtGui.QLabel(self.gbox_lithprops)
        ...
        label_5 = QtGui.QLabel(self.gbox_lithprops)
        label_5.setText("Remanent Inclination")
        self.glayout3.addWidget(label_5, 8, 0, 1, 1)
        ...
        label_6 = QtGui.QLabel(self.gbox_lithprops)
        label_6.setText("Remanent Declination")
        self.glayout3.addWidget(label_6, 9, 0, 1, 1)
        ...
        label_10 = QtGui.QLabel(self.gbox_lithprops)
        label_10.setText("Density (g/cm3)")
        self.glayout3.addWidget(label_10, 3, 0, 1, 1)
