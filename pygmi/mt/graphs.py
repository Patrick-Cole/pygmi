...
class MyMplCanvas(FigureCanvasQTAgg):
    ...
    def update_phase(
        ...
        tmp = []
        tmp2 = {"skew": "skew", "phimin": "phi_min", "phimax": "phi_max"}
        for i in ptdict:
...
class PlotPhaseTensor(ContextModule):
    ...
    def __init__(self, parent=None):
        ...
        pb_export = QtWidgets.QPushButton("Export current frequency to shapefiles")
    ...
    def change_band(self):
        ...
        self.mmc.update_phase(
            self.edi_list, freq, tipper, ecol, esize, asize, ahwidth, ahlength
        )
    ...
    def export(self):
        ...
        period = 1.0 / float(self.cmb_1.currentText())
        create_tensor_tipper_shapefiles(datadir, odir, period)

        QtWidgets.QMessageBox.information(
            self.parent, "Information", "Export completed!"
        )
