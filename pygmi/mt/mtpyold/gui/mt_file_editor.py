...
class SiteTab(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        self.lat_label = QtWidgets.QLabel(
            'Station Latitude (decimal or HH:MM:SS.ms)')
        ...
        self.lon_label = QtWidgets.QLabel(
            'Station Longitude (decimal or HH:MM:SS.ms)')
        ...
        if self.Site.Location.easting is None:
            ...
            self.easting_edit.setText(
                '{0:.3f}'.format(self.Site.Location.easting))
        ...
        if self.Site.Location.northing is None:
            ...
            self.northing_edit.setText(
                '{0:.3f}'.format(self.Site.Location.northing))
    ...
    def _set_ll(self):
        if self.Site.Location.easting is not None and \
           ...
           self.Site.Location.utm_zone is not None:
            ...
            print(self.Site.Location.easting,
                  self.Site.Location.northing, self.Site.Location.utm_zone)
    ...
    def set_dec(self):
        try:
            ...
            self.dec_edit.setText('{0:.3f}'.format(
...
class FieldNotesTab(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        self.data_logger_id_edit = QtWidgets.QLineEdit(
            self.FieldNotes.DataLogger.id)
        ...
        self.dq_good_periods_min.editingFinished.connect(
            self.set_dq_period_min)
        self.dq_good_periods_max = QtWidgets.QLineEdit()
        self.dq_good_periods_max.editingFinished.connect(
            self.set_dq_period_max)
        ...
        self.dq_warning_flag_combo.currentIndexChanged.connect(
            self.set_dq_flag)
    ...
    def set_dq_period_min(self):
        ...
        self.dq_good_periods_min.setText('{0:.5g}'.format(
    ...
    def set_dq_period_max(self):
        ...
        self.dq_good_periods_max.setText('{0:.5g}'.format(
...
class Magnetometer_Widget(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        self.h_id_edit = QtWidgets.QLineEdit(
            '{0}'.format(self.Magnetometer.id))
...
class ProcessingTab(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        self.software_version_edit.editingFinished.connect(
            self.set_software_version)

        self.software_author_label = QtWidgets.QLabel('Author')
        self.software_author_edit = QtWidgets.QLineEdit()
        self.software_author_edit.editingFinished.connect(
            self.set_software_author)
        ...
        self.software_author_org_label = QtWidgets.QLabel(
            'Author Organization')
...
class ProvenanceTab(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        self.submitter_name_edit.editingFinished.connect(
            self.set_submitter_name)

        self.submitter_email_label = QtWidgets.QLabel('email')
        self.submitter_email_edit = QtWidgets.QLineEdit()
        self.submitter_email_edit.editingFinished.connect(
            self.set_submitter_email)
...
class CopyrightTab(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        self.release_status_combo.currentIndexChanged.connect(
            self.set_release_status)
