...
import pygmi.mt.mtpyold.imaging.plotstrike2d as plotstrike2d
import pygmi.mt.mtpyold.analysis.staticshift as staticshift
import pygmi.mt.mtpyold.imaging.mtplottools as mtplt
...
#        self.resize(1920, 1080)
    ...
    def update_edi_metadata(self):
        self.plot_widget.mt_obj._edi_obj = copy.deepcopy(
...
class PlotWidget(QtWidgets.QWidget):
    ...
    def meta_edit_loc(self):
        ...
        self.meta_loc_edit.setText(
            '{0}'.format(self.mt_obj._edi_obj.Header.loc))
    ...
    def fill_metadata(self):
        ...
        self.meta_date_edit.setText('{0}'.format(
            self.mt_obj._edi_obj.Header.filedate))
        self.meta_loc_edit.setText(
            '{0}'.format(self.mt_obj._edi_obj.Header.loc))
        self.meta_acq_edit.setText('{0}'.format(
            self.mt_obj._edi_obj.Header.acqby))
        self.remove_distortion_num_freq_edit.setText(
            '{0:.0f}'.format(self.mt_obj.Z.freq.size))
            ...
            # mask phase points
                ...
                try:
                    ...
                    try:
                        ...
                        f_index = np.where(
                            self.mt_obj.Z.freq == 1. / data_period)
                        d_index = (f_index,
                                   np.array([1]),
                                   np.array([0]))
                        print('***Picked Invalid Point***', d_index)
...
class EDITextEditor(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        if self.edi_obj.Define_measurement.refelev is None:
            ...
            self.define_reflat_edit.setText('{0:.5f}'.format(
        ...
        if self.edi_obj.Define_measurement.reflon is None:
            ...
            self.define_reflon_edit.setText('{0:.5f}'.format(
