...
import pygmi.mt.mtpyold.modeling.modem
...
# from pygmi.mt.mtpyold.gui.get_edi_files import Get_EDI_Files
import sys
# import copy
...
class ModEM_Mesh_Window(QtGui.QMainWindow):
    ...
    def get_data_fn(self):
        ...
        self.mesh_widget.modem_data = pygmi.mt.mtpyold.modeling.modem.Data()
    ...
    def get_model_fn(self):
        ...
        self.mesh_widget.model_obj = pygmi.mt.mtpyold.modeling.modem.Model()
...
class MeshWidget(QtGui.QWidget):
    ...
    def __init__(self):
        ...
        self.model_obj = pygmi.mt.mtpyold.modeling.modem.Model()
    ...
    def setup_ui(self):
        ...
        self.z_target_edit.setText(
            '{0:.2f}'.format(self.model_obj.z_target_depth))
        ...
        self.rot_ang_edit.setText('{0:.2f}'.format(
    ...
    def get_data_fn(self):
        ...
        self.modem_data = pygmi.mt.mtpyold.modeling.modem.Data()
...
class MeshPlot(QtGui.QWidget):
    ...
    def plot_mesh(self, model_obj, east_limits=None, north_limits=None,
        ...
        station_plot_east = self.model_obj.station_locations['rel_east'] / \
            1000.
        station_plot_north = self.model_obj.station_locations['rel_north'] / \
            1000.
        ...
        self.ax_depth.set_ylabel('Depth (km)', fontdict={
                                 'size': 9, 'weight': 'bold'})
