...
from pygmi.mt.mtpyold.usgs import zen
from pygmi.mt.mtpyold.core import ts as mtts
...
class Z3DCollection(object):
    ...
    :Example:
        ...
        >>> from pygmi.mt.mtpyold.usgs import z3d_collections as zc
    ...
    def get_processing_loop_df(self, info_df):
        ...
        for station in info_df.station.unique():
            ...
            for sr in station_df.sampling_rate.unique():
                ...
                station_entry['block_{0:.0f}'.format(
                    sr)] = sr_df.block.unique().tolist()
