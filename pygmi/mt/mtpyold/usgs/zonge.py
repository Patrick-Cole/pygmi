...
class ZongeMTFT():
    ...
    :Example: ::
        ...
        >>> import pygmi.mt.mtpyold.usgs.zonge as zonge
    ...
    def __init__(self):
        ...
        self.rr_tdiff_dict = {'256': '060000',
                              '1024': '002000', '4096': '000500'}
    ...
    def get_survey_info(self, survey_file, station_name, rr_station_name=None):
        ...
        ----------
            **survey_file** : string
                              ...
                              pygmi.mt.mtpyold.utils.configfile
    ...
    def write_mtft_cfg(self, cache_path, station, rrstation=None,
        ...
        ----------
            ...
            **survey_file** : string
                             ...
                             format of pygmi.mt.mtpyold.utils.configfile
        ...
        # write log file
        lfid = open(os.path.join(os.path.dirname(
            save_path), 'MTFTcfg.log'), 'w')
...
class ZongeMTAvg():
    ...
    =============================== ===========================================
     ...
     Tipper                         pygmi.mt.mtpyold.core.z.Tipper object
     Tx_Type                        Transmitter type
     Unit_Length                    units of length (m) 
     Z                              pygmi.mt.mtpyold.core.z.Z object
...
#        else:
    ...
    def fill_Z(self):
        ...
        nz = flst.max()
        freq = self.comp_dict[self.comp_lst_z[np.where(flst == nz)[
            0][0]]]['freq']
            ...
            for ikey in clst:
                for kk, zz in enumerate(self.Z.z):
                    ...
                    if zz[ii, jj].real != 0.0:
                        ...
                        try:
                            mm = self.freq_dict_x[self.comp_dict[ikey]
                                                  ['freq'][kk]]
    ...
    def fill_Tipper(self):
        ...
        nz = flst.max()
        freq = self.comp_dict[self.comp_lst_tip[np.where(flst == nz)[
            0][0]]]['freq']
        freq = freq[np.nonzero(freq)]
    ...
    def write_edi_from_avg(self, avg_fn, station, survey_dict=None,
        ...
        survey_dict['elevation'] = gis_tools.assert_elevation_value(
            self.Rx_Length)
