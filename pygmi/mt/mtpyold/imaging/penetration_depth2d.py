...
from pygmi.mt.mtpyold.imaging.penetration import get_penetration_depth_by_index, load_edi_files, Depth2D
...
import pygmi.mt.mtpyold.modeling.occam2d_rewrite as occam2d_new
