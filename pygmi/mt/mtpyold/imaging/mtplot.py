...
objects in pygmi.mt.mtpyold.core to create an input, otherwise contact us and we can try
to build something.
...
:Example: ::
    ...
    >>> import pygmi.mt.mtpyold.imaging.mtplot as mtplot
    >>> import os
...
import pygmi.mt.mtpyold.imaging.plotpseudosection as plotrpps
import pygmi.mt.mtpyold.imaging.plotpt as plotpt
import pygmi.mt.mtpyold.imaging.phase_tensor_maps as plotptmaps
import pygmi.mt.mtpyold.imaging.phase_tensor_pseudosection as plotptps
import pygmi.mt.mtpyold.imaging.plotresidualptmaps as plotresidualptmaps
import pygmi.mt.mtpyold.imaging.plotresidualptps as plotresidualptps
import pygmi.mt.mtpyold.imaging.plot_mt_response as plotresponse
import pygmi.mt.mtpyold.imaging.plotstations as plotstations
import pygmi.mt.mtpyold.imaging.plotstrike as plotstrike
