...
from pygmi.mt.mtpyold.imaging.mtplottools import PlotSettings
...
class PlotMTResponse(PlotSettings):
    ...
    arrays or objects like class pygmi.mt.mtpyold.core.z.Z.  Or if the data is in 
    resistivity and phase format they can be input as arrays or a class
    pygmi.mt.mtpyold.imaging.mtplot.ResPhase.  Or you can put it into a class
    pygmi.mt.mtpyold.imaging.mtplot.MTplot.
    ...
    ----------
        ...
        **tipper_object**: class pygmi.mt.mtpyold.core.z.Tipper
                            object of pygmi.mt.mtpyold.core.z. If this is input be sure the
                            attribute z.freq is filled.  
                            *default* is None 

        **mt_object** : class pygmi.mt.mtpyold.imaging.mtplottools.MTplot
                        object of pygmi.mt.mtpyold.imaging.mtplottools.MTplot
                        *default* is None
    ...
    --------------------
        ...
        *fig_dpi*: int
        ...
        :Example: ::
            ...
            >>> import pygmi.mt.mtpyold.core.mt.MT
            >>> import pygmi.mt.mtpyold.imaging.plot_mt_response.PlotMTResponse
            ...
            if Z2 is not None:
                self.axr.legend((self.ebxyr[0], self.ebyxr[0], self.ebdetr[0], self.ebxyr2[0], self.ebyxr2[0], self.ebdetr2[0],),
                                ('$Z_{xy}$', '$Z_{yx}$', '$\det(\mathbf{\hat{Z}})$',
                                 '$Z2_{xy}$', '$Z2_{yx}$', '$\det(\mathbf{\hat{Z2}})$'),
                                loc=3,
                                markerscale=1,
                                borderaxespad=.01,
                                labelspacing=.07,
        ...
        if self.show_resphase_xticklabels:
            if self.plot_num in [1, 3]:
                ...
                self.axr2.tick_params(
                    axis='x', pad=2, direction='in', which='both', labelsize=self.font_size - 1)
    ...
    def save_plot(self, save_fn, file_format='pdf', orientation='portrait',
        ...
        :Example: ::
            ...
            >>> # to save plot as jpg
            >>> import pygmi.mt.mtpyold.imaging.mtplottools as mtplot
