...
class PlotPhaseTensor(mtpl.MTEllipse):
    ...
    ----------
        ...
        **mt_object** : class pygmi.mt.mtpyold.imaging.mtpl.MTplot.mtpl.MTplot
                        object of pygmi.mt.mtpyold.imaging.mtpl.MTplot.mtpl.MTplot
                        *default* is None
    ...
    -----------
        ...
        -mt            pygmi.mt.mtpyold.imaging.mtpl.MTplot.mtpl.MTplot object (PlotPhaseTensor._mt)
    ...
    def save_plot(self, save_fn, file_format='pdf', orientation='portrait',
        ...
        :Example: ::
            ...
            >>> # to save plot as jpg
            >>> import pygmi.mt.mtpyold.imaging.mtpl.MTplottools as mtpl.MTplot
