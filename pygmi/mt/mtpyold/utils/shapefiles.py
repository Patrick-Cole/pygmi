...
from pygmi.mt.mtpyold.utils.gis_tools import project_point_ll2utm, get_utm_zone
        ...
        for plot_per in periods:
            ...
            for mt_obj in self.mt_obj_list:
                ...
                if len(p_index) >= 1:
                    ...
                    print(("The period %s is NOT found for this station %s" %
...
#            print(self.pt_dict.keys()) # (self.pt_dict[plot_per])['phimax'].size)
            ...
            for isite, pt_array in enumerate(self.pt_dict[plot_per]):
                ...
                new_feature.SetField(
                    "Name", pt_array['station'].decode('UTF-8'))
...
# ===========================
    def write_data_pt_shape_files_modem(self, modem_data_fn,
        ...
        modem_obj = pygmi.mt.mtpyold.modeling.modem.Data()
    ...
    def write_resp_pt_shape_files_modem(self, modem_data_fn, modem_resp_fn,
        ...
        modem_data_obj = pygmi.mt.mtpyold.modeling.modem.Data()
        ...
        modem_resp_obj = pygmi.mt.mtpyold.modeling.modem.Data()
