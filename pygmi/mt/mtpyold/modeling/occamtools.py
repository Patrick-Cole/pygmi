...
import pygmi.mt.mtpyold.modeling.winglinktools as wlt
import matplotlib.pyplot as plt

import pygmi.mt.mtpyold.utils.gis_tools
...
class Occam2DData:
    ...
    def make2DdataFile(self, edipath, mmode='both', savepath=None,
        ...
        :Example: ::
            ...
            >>> import pygmi.mt.mtpyold.core.occamtools as occam
            >>> ocd = occam.Occam2DData()
        ...
        for kk, station in enumerate(stationlst):
            ...
            for filename in os.listdir(edipath):
                if fnmatch.fnmatch(filename, station + '*.edi'):
                    ...
                    zone, east, north = pygmi.mt.mtpyold.utils.gis_tools.ll_to_utm(
                        23, z1.lat, z1.lon)
        ...
        if type(freqstep) is list or type(freqstep) is not int:
            ...
            fdict = dict([('%.6g' % ff, ii) for ii, ff in
                          enumerate(
                              mfreq[list(range(0, maxflen, freqstep))], 1)
                          if ff != 0])
        ...
        for kk in range(nstat):
            ...
            for jj, ff in enumerate(freq):
                ...
                try:
                    ...
                    if phaseyx > 180:
                        phaseyx = phaseyx - 360
                        print('Found Negative Phase',
                              surveylst[kk]['station'], ff)
    ...
    def read2DdataFile(self):
        ...
        :Example: ::
            ...
            >>> import pygmi.mt.mtpyold.modeling.occamtools as occam
            >>> ocd = occam.Occam2DData()
            >>> ocd.datafn = r"/home/Occam2D/Line1/Inv1/Data.dat"
            >>> ocd.read2DdataFile()
