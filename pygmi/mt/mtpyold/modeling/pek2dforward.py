...
import pygmi.mt.mtpyold.modeling.pek1dclasses as p1dc
import numpy as np
import os
...
#        print np.shape(data)
    ...
    def build_modelfilestring(self):
        ...
        for meshstep in [self.meshblockwidths_x, meshz]:
            modelfilestring.append(p2d.create_multiple_line_string(meshstep,
                                                                   10, '%5.2f'))
        ...
        modelfilestring.append(
            '%5i' % (len(list(self.resistivity_dict.keys())) + 1))
