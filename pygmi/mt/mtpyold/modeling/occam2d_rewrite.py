...
import pygmi.mt.mtpyold.analysis.geometry as MTgy
import pygmi.mt.mtpyold.core.mt as mt
import pygmi.mt.mtpyold.modeling.winglinktools as MTwl
from pygmi.mt.mtpyold.imaging.mtplottools import plot_errorbar
from pygmi.mt.mtpyold.utils.calculator import centre_point
from pygmi.mt.mtpyold.utils.gis_tools import get_epsg, project_point_ll2utm
...
class Mesh():
    ...
    :Example: ::
        ...
        >>> import pygmi.mt.mtpyold.modeling.occam2d as occcam2d
    ...
    def build_mesh(self):
        ...
        print('=' * 55)
        print('  number of horizontal nodes = {0}'.format(
            self.x_nodes.shape[0]))
        print('  number of vertical nodes   = {0}'.format(
            self.z_nodes.shape[0]))
        print('  Total Horizontal Distance  = {0:2f}'.format(
            self.x_nodes.sum()))
        print('  Total Vertical Distance    = {0:2f}'.format(
            self.z_nodes.sum()))
        print('=' * 55)
    ...
    def write_mesh_file(self, save_path=None, basename='Occam2DMesh'):
        ...
        mesh_lines.append(
            'MESH FILE Created by pygmi.mt.mtpyold.modeling.occam2d\n')
    ...
    def read_mesh_file(self, mesh_fn):
        ...
        if self.x_nodes.shape[0] != nh - 1:
            ...
            print('The header number {0} should read {1}'.format(
                nh - 1, new_nh))
...
class Profile():
    ...
    **Attributes**          Description    
    ======================= ===================================================
    edi_list                list of pygmi.mt.mtpyold.core.mt.MT instances for each .edi
    ...
    :Example: ::
        ...
        >>> import pygmi.mt.mtpyold.modeling.occam2d as occam
        >>> edi_path = r"/home/mt/edi_files"
    ...
    def _get_edi_list(self):
        ...
        each element of the list is a pygmi.mt.mtpyold.core.mt.MT object
        """
            ...
            if self.station_list is not None:
                for station in self.station_list:
                    ...
                    if len(tmp_edi_list) == 0:
                        print("Didn't find edi file {} in directory {}".format(
                            edi, self.edi_path))
...
class Regularization(Mesh):
    ...
    def __init__(self, station_locations=None, **kwargs):
        ...
        self.model_name = 'model made by pygmi.mt.mtpyold.modeling.occam2d'
...
class Data(Profile):
    ...
    **data** : is a list of dictioinaries containing the data for each station.
    ...
    edi_list              list of pygmi.mt.mtpyold.core.mt instances for each .edi file
                          read
