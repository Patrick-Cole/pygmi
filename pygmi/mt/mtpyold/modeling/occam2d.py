...
import pygmi.mt.mtpyold.modeling.winglink as MTwl
...
import pygmi.mt.mtpyold.utils.mesh_tools as mtmesh
...
class Regularization(Mesh):
    ...
    def build_regularization(self):
        ...
        station_col = [
            2] * int((self.x_nodes.shape[0] - 2 * self.num_x_pad_cells) / 2)
    ...
    def read_response_file(self, resp_fn=None):
        ...
        try:
            ...
            try:
                ...
                raise OccamInputError("Filed to read file {}. numpy error message: {}".format(
