...
import pygmi.mt.mtpyold.utils.convert_birrp_output as MTbp
import numpy as np
import pygmi.mt.mtpyold.utils.exceptions as MTex
import pygmi.mt.mtpyold.uofa.qel_monitoring_j2edi as qel2edi
import pygmi.mt.mtpyold.utils.edi2columnsonly as edi2col
import pygmi.mt.mtpyold.uofa.simpleplotEDI as smplplt
import pygmi.mt.mtpyold.uofa.simpleplotCOH as smplpltCOH
...
for stationdir in dirs:
    ...
    for daydir in daydirs:
        ...
        try:
            ...
            print('no information found in folder {0}'.format(
                op.abspath(os.curdir)))
            continue
        try:
