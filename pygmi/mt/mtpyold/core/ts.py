...
import pygmi.mt.mtpyold.processing.filter as mtfilter
...
class MTTS(object):
    ...
    :Example: ::
        ...
        >>> import pygmi.mt.mtpyold.core.ts as ts
        >>> import numpy as np
        >>> MTTS = ts.MTTS()
    ...
    def sampling_rate(self, sampling_rate):
        ...
        try:
            ...
            raise MTTSError(
                "Input sampling rate should be a float not {0}".format(type(sampling_rate)))
    ...
    def start_time_epoch_sec(self, epoch_sec):
        ...
        try:
            ...
            raise MTTSError("Need to input epoch_sec as a float not {0} {1".format(
