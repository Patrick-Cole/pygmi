   ...
   """
    ...
    def _set_layerdepth_defaults(self, z1_threshold=3., bottomlayer_threshold=2.):
        ...
        # if bottom layer less than a factor of 2 greater than target depth then adjust deeper
            ...
            print("bottom layer not deep enough for target depth, set to {} m".format(
                self.bottom_layer))
        ...
        if self.z1_layer is None:
            ...
            print("z1 layer not deep enough for target depth, set to {} m".format(
                self.z1_layer))
...
class Run(object):
    ...
    def run_occam1d(self):
        ...
        if test == 0:
            print('=========== Ran Inversion ==========')
            print('  check {0} for files'.format(
                os.path.dirname(self.startup_fn)))
...
def build_run():
    ...
    for rundir in list(run_directories.keys()):
        ...
        for startupfile in run_directories[rundir]:
            ...
            iterfilelist = [ff for ff in os.listdir(wd) if (
            ...
            if len(iterfilelist) > 0:
                ...
                target_rms = float(startup.misfit_value) * \
