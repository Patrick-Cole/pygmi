# -----------------------------------------------------------------------------
# Name:        test_pfmod.py (part of PyGMI)
#
# Author:      Patrick Cole
...
def main():
    ...
    ifile = "testdata/dyke"
    samplescale = 1.0  # Horizontal scale of the samples.
    power = 2.0  # This parameter changes thinkness of voxels with depth.
    print("File:", ifile)
    ...
    ax2.set_ylabel("nT")
    ax2.legend(loc="upper right", shadow=True, title="Magnetic Calculation")
