...
def test_histeq():
    ...
    dat2 = [
        [0.0, 10922.66666667, 32768.0, 10922.66666667],
        [0.0, 10922.66666667, 32768.0, 10922.66666667],
        [0.0, 10922.66666667, 32768.0, 10922.66666667],
        [0.0, 10922.66666667, 32768.0, 10922.66666667],
    ]
...
def test_normalisation():
    ...
    datout = np.ma.array([[0.0, 1.0], [0.0, 1.0]])

    np.testing.assert_array_equal(outdata[0].data, datout)

    outdata = normalisation.norm(indata, "mean")
    datout = np.ma.array([[-1.0, 1.0], [-1.0, 1.0]])
    ...
    datout = np.ma.array([[0.0, 255.0], [0.0, 255.0]])
...
def test_smooth():
    ...
    datout = np.array(
        [
            [0.36, 0.48, 0.6, 0.6, 0.6, 0.48, 0.36],
            [0.48, 0.64, 0.8, 0.8, 0.8, 0.64, 0.48],
            [0.6, 0.8, 1.0, 1.0, 1.0, 0.8, 0.6],
            [0.6, 0.8, 1.0, 1.04, 1.04, 0.84, 0.64],
            [0.6, 0.8, 1.0, 1.04, 1.04, 0.84, 0.64],
    ...
    datout = np.array(
        [
            ...
            [0.50989872, 0.76229868, 1.0, 1.0, 1.0, 1.0, 0.74760005],
            [0.50989872, 0.76229868, 1.0, 1.0, 1.0, 1.0, 0.74760005],
            [0.50989872, 0.76229868, 1.0, 1.0, 1.06370574, 1.06499268, 0.81130578],
            [0.50989872, 0.76229868, 1.0, 1.0, 1.06499268, 1.06630562, 0.81259272],
            [
                0.38120031,
                0.56989453,
                0.74760005,
...
def test_agc():
    ...
    datout = np.array(
        [
            ...
            [1e20, 0, 0, 0, 0, 0, 1e20],
            [1e20, 0, 2.25, 1.50, 2.25, 0, 1e20],
            [1e20, 0, 1.50, 1, 1.50, 0, 1e20],
            [1e20, 0, 2.25, 1.50, 2.25, 0, 1e20],
            [1e20, 0, 0, 0, 0, 0, 1e20],
            [1e20, 1e20, 1e20, 1e20, 1e20, 1e20, 1e20],
        ]
    ...
    datout = np.array(
        [
            [1e20, 1e20, 1e20, 1e20, 1e20, 1e20, 1e20],
            [1e20, 0, 0, 0, 0, 0, 1e20],
            [1e20, 0, 1.5, 1.22474487, 1.5, 0, 1e20],
            [1e20, 0, 1.22474487, 1, 1.22474487, 0, 1e20],
            [1e20, 0, 1.5, 1.22474487, 1.5, 0, 1e20],
            [1e20, 0, 0, 0, 0, 0, 1e20],
            [1e20, 1e20, 1e20, 1e20, 1e20, 1e20, 1e20],
        ]
