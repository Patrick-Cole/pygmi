...
.. figure:: _images/rastervis.png

   Visibility calculation options.


References
^^^^^^^^^^
 Cooper,G.R.J. 2005. Analysing potential field data using visibility. Computers and Geosciences, 31, p.877-881
