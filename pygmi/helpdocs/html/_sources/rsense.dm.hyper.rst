...
5. **Load ENVI spectral library** – This can be any spectral library in ENVI spectral library format (**SLI**). The user then chooses the appropriate reference spectrum to compare with.
