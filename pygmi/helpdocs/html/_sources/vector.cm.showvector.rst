...
.. figure:: _images/vectorlines.png

   Simple display of line vector data. The interface will be the same for polygon data.
...
.. figure:: _images/vectorpointmap.png
   ...
   Vector data display interface for point data.
