...
5. **Shift bands to median value before mosaic. May allow for cleaner mosaic if datasets are offset** - unchecked by default.
6. **Mosaic Method**:
...
7. **Save each band separately in a “mosaic” subdirectory** - this is useful when the resultant mosaic is too large.

.. figure:: _images/rastermosaic.png

   Dataset Mosaic interface.
