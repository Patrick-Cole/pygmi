...
3. **Perform RTP on data** – A toggle box allow the user to choose whether the data must be reduced to the pole. If this option is selected the user must provide the following inputs:
