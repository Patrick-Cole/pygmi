...
4. **Amplitude Correction Inclination for low latitudes** - Pseudo inclination used to correct the amplitude of the RTP filter near the equatior (Macleod et al, 1993). Only used if the magnitude of the actual inclination is less than the magnitude of this pseudo inclination.
...
References
^^^^^^^^^^
 Macleod, I.N., Jones, K., Dai, T.F., 1993. 3-D analytic signal in the interpretation of total magnetic ﬁeld data at low magnetic latitudes. Exploration Geophysics 24, 679–688.