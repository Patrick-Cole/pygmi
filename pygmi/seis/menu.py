...
# -----------------------------------------------------------------------------
"""Seismology menu routines."""

from PySide6 import QtGui, QtWidgets

from pygmi.seis import beachball, del_rec, graphs, iodefs, utils
...
class MenuWidget:
    ...
    def __init__(self, parent=None):
        ...
        self.action_check_desc = QtGui.QAction("Correct SEISAN Type 3 Descriptions")
        ...
        self.action_show_TP_plots = QtGui.QAction("Show Temporal b-value Plots")
        context_menu["Seis"].addAction(self.action_show_TP_plots)
        self.action_show_TP_plots.triggered.connect(self.show_TP_plots)

        self.action_show_SV_plots = QtGui.QAction("Plot spatial variation of b values")
        ...
        self.action_sexport = QtGui.QAction("Export Summary to CSV, XLSX or SHP")
    ...
    def beachball(self):
        ...
        self.parent.item_insert("Step", "Fault Plane Solutions", beachball.BeachBall)

    def import_seisan(self):
        """Import Seismic data."""
        self.parent.item_insert("Io", "Import Seismic Data", iodefs.ImportSeisan)

    def correct_desc(self):
        """Correct Seisan descriptions."""
        self.parent.item_insert(
            "Step", "Correct SEISAN Descriptions", utils.CorrectDescriptions
        )

    def filter_seisan(self):
        """Filter Seisan."""
        self.parent.item_insert("Step", "Filter SEISAN Data", iodefs.FilterSeisan)

    def import_genfps(self):
        """Import Generic Fault Plane Solution."""
        self.parent.item_insert("Io", "Import Generic FPS", iodefs.ImportGenericFPS)
