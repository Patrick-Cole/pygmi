.. PyGMI documentation master file, created by
   sphinx-quickstart on Thu Sep 11 13:43:52 2014.
...
The latest version can be downloaded at the `release <https://github.com/Patrick-Cole/pygmi/releases>`_ section.
...
* Remote sensing ratios, hyperspectral processing, change detection and improved imports.

It is released under the `Gnu General Public License version 3.0 <http://www.gnu.org/copyleft/gpl.html>`_

The PyGMI :doc:`Wiki <wiki>` pages, include installation and full usage! Contributors can look `here <https://github.com/Patrick-Cole/pygmi/blob/pygmi3/CONTRIBUTING.md>`_ for ways to contribute.

The latest release version (including windows installers) can be found at this `link <https://github.com/Patrick-Cole/pygmi/releases>`_.
