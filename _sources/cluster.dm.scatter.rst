...
.. figure:: _images/clustscatter.png

   Scatter Plot Tool interface.

The **Cross Plot Settings** control what is displayed in the scatter plot:

1. Histogram of the band selected for the x-axis (**X Data Band**).
2. Histogram of the band selected for the y-axis (**Y Data Band**).
3. Scatter plot of the two selected bands. **Cluster Overlay** allows the user to select what will be displayed. It can be a colour map of the histogram amplitudes, or the classes.
4. The user can draw a polygon around an area of interest on the scatter plot by simply **left-clicking** on it. The pixels within the polygon will be highlighted in the map view. Click **Delete Polygon** to remove the polygon.

.. figure:: _images/clustscatter1.png

   Cross Plot Settings on the Scatter Plot interface.
...
.. figure:: _images/clustscatter2.png
   ...
   Map Settings on the Scatter Plot interface.
...
.. figure:: _images/clustscatter3.png

   Example of investigating the classification result using the Scatter Plot Tool.
