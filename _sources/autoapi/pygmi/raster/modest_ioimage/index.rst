...
.. py:module:: pygmi.raster.modest_ioimage
...
.. autoapisummary::
   ...
   pygmi.raster.modest_ioimage.ModestImage
...
.. autoapisummary::
   ...
   pygmi.raster.modest_ioimage.imshow
   pygmi.raster.modest_ioimage.extract_matched_slices
...
.. py:class:: ModestImage(*args, **kwargs)
   ...
   .. py:method:: get_cursor_data(event)
      ...
      :type event: matplotlib cursor event.
...
.. py:function:: imshow(axes, X, cmap=None, norm=None, aspect=None, interpolation=None, alpha=None, vmin=None, vmax=None, origin=None, extent=None, shape=None, filternorm=1, filterrad=4.0, imlim=None, resample=None, url=None, suncell=None, suntheta=None, sunphi=None, sunalpha=None, piter=iter, showlog=print, **kwargs)
