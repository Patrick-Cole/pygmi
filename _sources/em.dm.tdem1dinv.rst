...
3. **Invert Station**: Click on this to start the inversion process. The **Process Log** window in the main PyGMI interface displays the progress and some inversion parameters.
4. The waveform used by the TDEM system.
5. The inversion results showing the model and the fit of the modelled data to the observed data.
...
.. figure:: _images/eminv.png

   The TDEM 1D Inversion interface.

.. figure:: _images/eminv2.png

   Process Log during inversion.
